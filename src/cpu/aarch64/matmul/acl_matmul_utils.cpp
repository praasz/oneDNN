...
status_t init_conf_matmul_fixed_format(acl_matmul_conf_t &amp,
    ...
    auto acl_src_data_t = acl::acl_utils::get_acl_data_t(src_md.data_type);
    auto acl_wei_data_t = acl::acl_utils::get_acl_data_t(wei_md.data_type);
    auto acl_dst_data_t = acl::acl_utils::get_acl_data_t(dst_md.data_type);
    ...
    acl::acl_utils::reorder_to_weight_format(amp.wei_tensor_info, wei_md,
