...
const std::map<pk_impl_key_t, std::vector<impl_list_item_t>> &impl_list_map() {
    static const std::map<pk_impl_key_t, std::vector<impl_list_item_t>> the_map = REG_POOLING_P({
        {{forward}, {
            ...
            CPU_INSTANCE_SSE41(jit_uni_pooling_fwd_t, sse41, f32)
            ...
            CPU_INSTANCE_SSE41(jit_uni_i8i8_pooling_fwd_t, sse41)
        ...
        {{backward}, REG_BWD_PK({
            ...
            CPU_INSTANCE_SSE41(jit_uni_pooling_bwd_t, sse41, f32)
