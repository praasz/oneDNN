...
jit_brgemm_ip_conf_t::get_desired_weights_tag() const {
    ...
    const bool is_not_vnni_tag = (jbgp.wei_dt == f32 || (jbgp.weights_decompression && jbgp.wei_dt == u8))
...
status_t jit_brgemm_ip_conf_t::init_conf_base(cpu_isa_t isa,
    ...
    jbgp.weights_decompression = one_of(jbgp.src_dt, f32, bf16) && jbgp.wei_dt == u8;
